...
export const PROMPT_CREATIVE_MAPPINGS: PromptCreativeMapping[] = [
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top 60% is [PRIMARY BRAND COLOR] and bottom 40% is [CONTRAST COLOR like warm cream].
        [YOUR PRODUCT] sits centered where colors meet, soft studio lighting.
        Upper area: large [CONTRAST TEXT] sans-serif reading "[YOUR OFFER like YOUR FIRST MONTH FREE]".
        Below: "[OFFER DETAILS]".
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a testimonial ad set in [SETTING like bright bathroom / kitchen] with warm natural light.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top: bold [BRAND COLOR] text "[HEADER like What Makes [PRODUCT] Different]".
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference.
        Create: a social proof ad on [BACKGROUND like warm cream].
        Top: "[HEADLINE like Join 1,000,000+ Members]" in bold [BRAND COLOR].
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Bottom: bold white sans-serif "[PUNCHLINE like THE REVIEWS ARE IN.]".
        [BRAND] logo bottom right.
        4:5 aspect ratio.
      `,
    },
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a static ad with a [LIFESTYLE PHOTO DESCRIPTION like man mid-golf-swing in tropical patterned polo and khaki pants] occupying the left two-thirds of the frame, shot outdoors in [SETTING like golf course with palm trees], bright natural daylight.
        [BRAND] logo top center in bold.
        Below logo: large bold sans-serif quote text reading "[ENDORSEMENT HEADLINE like THE GREATEST PANTS IN GOLF]" in [TEXT COLOR like white or black].
        Bottom right foreground: three [PRODUCT VARIANTS like folded pairs of shorts/pants] fanned in an overlapping arrangement showing [COLOR 1], [COLOR 2], and [COLOR 3].
        ...
        [MOOD like confident, athletic, aspirational but accessible].
        1:1 aspect ratio.
      `,
    },
    creative: {
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a static ad on a white-to-[LIGHT GRADIENT COLOR like warm golden beige] gradient background, gradient fading from top to bottom.
        Top: large bold [TEXT COLOR like dark brown] sans-serif headline reading "[HEADLINE like So tasty you'll forget it's actually healthy.]"
        Center: [YOUR PRODUCT like single stand-up pouch] on white background, soft studio lighting.
        Floating near the product: a small circular badge reading "[PRICE POINT like AS LOW AS $2.63 PER MEAL!]" in [BADGE COLOR].
        Flanking the product on both sides: four stat callouts with curved arrows pointing toward the product.
        Left side top: "[STAT 1 like 20g]" in oversized bold text with "[LABEL like PROTEIN]" below.
        Left side bottom: "[STAT 2 like 280]" with "[LABEL like CALORIES]".
        Right side top: "[STAT 3 like 900k+]" with "[LABEL like HAPPY CUSTOMERS]".
        Right side bottom: "[STAT 4 like 30k+]" with "[LABEL like 5-STAR REVIEWS]" and five filled gold stars beneath.
        Arrows are simple hand-drawn-style curved lines in [ARROW COLOR like black].
        Bottom foreground: [FLAVOR PROPS like scattered chocolate chip cookie dough balls and chocolate chips] adding appetite appeal.
        No brand logo.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference. Match the exact product design, colors, and typography style precisely.
        Create: a static ad on a [BACKGROUND like soft pink-to-hot-pink gradient] background.
        Top: oversized bold white all-caps sans-serif headline reading "[HEADLINE like 24/7 PEAK FEMALE PERFORMANCE]".
        Below headline: a horizontal [ACCENT COLOR like purple/violet] banner bar divided into [NUMBER like five] equal segments separated by thin vertical lines, each containing a two-word benefit label in white text: "[BENEFIT 1 like Morning Energy]", "[BENEFIT 2 like Focus Amplifier]", "[BENEFIT 3 like Deep Sleep]", "[BENEFIT 4 like Ultimate Beauty]", "[BENEFIT 5 like Metabolism Booster]".
        Center-to-bottom: an open [PACKAGING like branded gift box] photographed at a slight overhead angle showing [NUMBER like three] [PRODUCTS like supplement jars] nestled inside, each a different [COLOR-CODED VARIANT].
        In the lower foreground: a [LIFESTYLE PROP like woman's hand holding a pastel dumbbell] entering the frame from bottom.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top: oversized bold black sans-serif headline reading "[HOOK HEADLINE like IF YOU'RE GOING THROUGH PERI..]" with [EMOJI like 😅] at the end.
        Center: a social media comment card with light gray rounded-rectangle background containing: a small circular profile avatar (top left), bold name "[REVIEWER NAME like Elaine McLean]", and a multi-sentence review in regular-weight sans-serif: "[FULL REVIEW TEXT, 3-4 sentences, conversational and emotional]".
        Small gray timestamp "[TIMESTAMP like 2d]" below the comment.
        Bottom center: [YOUR PRODUCT like product box and bar/bottle] photographed at a slight angle on white, soft studio lighting.
        No brand logo.
        No stars.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference. Match the exact product design, colors, and typography style precisely.
        Create: a static ad on a clean white background.
        Top center: large [ACCENT COLOR like periwinkle blue] opening quotation marks.
        Below: mixed-weight headline in black — the first line in italic serif or semi-bold reading "[SETUP LINE like I've been]", the next two lines in enormous heavy-weight bold all-caps sans-serif reading "[BAIT PHRASE like FAKING IT / WITH MY HUSBAND]", followed by a smaller sentence-case line reading "[REVEAL like since perimenopause — with [BRAND] I don't have to]".
        Closing quotation marks and "[ATTRIBUTION like - Erin D.]" in regular weight.
        Left side bottom third: [YOUR PRODUCT like supplement bottle] at a slight angle with [PRODUCT DETAILS like capsules scattered nearby].
        To the left of the product: a [TRUST BADGE like circular seal reading "Happiness 60 DAY Guaranteed"].
        Right side bottom third: [NUMBER like five] filled [ACCENT COLOR] stars and bold text reading "[REVIEW COUNT like 3,600+] 5-Star Reviews" with a [BRAND ICON].
        Bottom edge: small disclaimer text "[DISCLAIMER like Results may vary based on individual. No results guaranteed.]"
        1:1 aspect ratio.
      `,
    },
    creative: {
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference. Match the exact product design, colors, and typography style precisely.
        Create: a static ad on a solid [BRAND COLOR like periwinkle/lavender blue] background.
        Top: large bold white serif or semi-bold sans-serif pull-quote reading "[HEADLINE QUOTE like "I finally found something that works!"]" in quotation marks.
        Below the quote: five filled gold stars, large.
        Center-left: a white rounded-rectangle review card with subtle shadow containing: gray circular avatar icon, bold name "[REVIEWER NAME like Dawn K.]" with [FLAG EMOJI like 🇺🇸], blue checkmark and "[VERIFIED BADGE TEXT like Verified Reviewer]" in [BRAND COLOR] text, then 3-4 sentences of review body text in regular weight dark text.
        At the bottom of the card: a blue "[READ MORE like ...Read more]" link and "[HELPFULNESS like Was this review helpful? 👍 150]".
        Right side, overlapping the card edge: [YOUR PRODUCT like cream jar with lid] photographed at a slight angle, soft studio lighting, casting a gentle shadow on the background.
        No brand logo.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top: bold [ACCENT COLOR like purple] filled banner bar spanning full width, white all-caps sans-serif reading "[HEADLINE like INCREDIBLY TASTY BREAKFAST IN 30 SECONDS]".
        Center: a [PERSON DETAIL like woman's hand] holding [YOUR PRODUCT like branded shaker cup] in mid-frame.
        Scattered around the edges: [FLATLAY PROPS like product sachets, pancakes on plates, blueberries, muffins, fruit] arranged organically to fill corners and edges, slightly out of focus.
        Four stat callouts with curved [ACCENT COLOR] arrows pointing toward the held product: "[STAT 1 like 20g] / [LABEL like PROTEIN]", "[STAT 2 like 900K] / [LABEL like HAPPY CUSTOMERS]", "[STAT 3 like 20+] / [LABEL like FLAVORS]", "[STAT 4 like 30K] / [LABEL like 5 STAR REVIEWS]" with five small gold stars.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference. Match the exact product design, colors, and typography style precisely.
        Create: a static ad on a clean white background.
        Top left: circular customer headshot photo of [PERSON DESCRIPTION like smiling woman, mid-60s, silver wavy hair, wearing blue top].
        To the right of the photo: bold name "[REVIEWER NAME like Veronica B.]" with a [VERIFIED ICON like blue checkmark].
        ...
        Key phrases within the quote are highlighted with [HIGHLIGHT COLOR like bright lime green / neon yellow] rectangular background fills behind the text: "[HIGHLIGHTED PHRASE 1 like thyroid removed]", "[HIGHLIGHTED PHRASE 2 like This is the best product I have found.]"
        Bottom right: [YOUR PRODUCT like supplement jar] at a slight angle, partially cropped at the bottom edge.
        To the left of the product: a circular [TRUST BADGE like "100% MONEY BACK / 90 DAYS / 100% GUARANTEE"] seal in [BADGE COLOR like lime green with dark text].
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a full-bleed moody portrait photo of [PERSON DESCRIPTION like young man in dark textured sweater holding an electric guitar], warm amber-toned lighting, shot on 50mm f/1.8, shallow depth of field, cinematic color grade with warm highlights and cool shadows.
        Lower 45% of the frame is a text overlay zone: a prominent white rounded-rectangle pill label reading "[CATEGORY TAG like HOT TOPIC]" in centered uppercase sans-serif, sized to span roughly one-third of the frame width.
        Below: very large, dominant, bold all-caps condensed sans-serif headline filling the width of the frame in white text with key words in [HIGHLIGHT COLOR]: "[HEADLINE like [BRAND] IS BLOWING UP ON TIKTOK — HERE'S WHY EVERYONE'S USING IT TO [ACTION]]".
        The headline should be oversized — at least 35% of the total frame height.
        Bottom center: "[@HANDLE like @waveform.watch]" in small white text.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference. Match the exact product design, colors, and visual tone precisely.
        Create: a static ad on a vibrant [GRADIENT like coral-pink to golden-yellow] gradient background, flowing diagonally from upper left to lower right.
        Upper left: oversized playful [FONT STYLE like rounded retro serif / Cooper Black style] white headline reading "[BOLD STATEMENT like This popcorn is so f*****g delicious.]" — text should feel loose, fun, and expressive, not rigid or corporate.
        Right side: [PERSON DETAIL like a hand reaching down from upper right] grabbing from [YOUR PRODUCT like the signature bright yellow popper bowl overflowing with fluffy popcorn].
        Product sits center-right, slightly below midline.
        Bottom left: [BRAND] logo in [LOGO COLOR like black] with "[PRODUCT DESCRIPTOR like Flavor Wrapped Popcorn Kernels]" in smaller text below.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Full background is a photorealistic close-up food scene of [INDULGENT FOOD like freshly baked raspberry donuts dusted with powdered sugar on a gray stone surface].
        Shot at 50mm f/2.8, shallow depth of field, warm bakery lighting.
        Top third: large bold white sans-serif headline reading "[HEADLINE like A protein bar that tastes like freshly baked raspberry donuts]" with one key word in bold italic for emphasis.
        [YOUR PRODUCT] packaged unit placed bottom-right, angled 15° as if casually laid into the scene.
        Bottom: semi-transparent white bar spanning full width with three stat columns separated by thin vertical lines: "[STAT 1 like 15g PROTEIN]" | "[STAT 2 like 2g SUGAR]" | "[STAT 3 like 180 CALORIES]".
        Very bottom edge: smaller bold sans-serif "[CLEAN LABEL CLAIM like NO ARTIFICIAL SWEETENERS]".
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top: oversized bold black serif or sans-serif headline reading "[PROVOCATIVE HEADLINE like They're not cheap.]" spanning the top 15%.
        Below: left-aligned body copy in smaller regular-weight black text, structured as short punchy sentences and line breaks (NOT paragraphs), building a persuasive argument about [CORE BRAND TENSION like why the price is justified].
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        A few [LOOSE UNITS like gummies / capsules] spilling casually at the base.
        Bottom 45%: a realistic Facebook-style comment card.
        Left: small circular profile photo of [PERSON DESCRIPTION like a man in his 30s, friendly smile, casual].
        Bold name "[FIRST NAME + LAST INITIAL like Alan R.]" above the comment.
        ...
        Below comment: "[TIMEFRAME like 4w]" · Like · Reply in gray.
        Bottom right of comment: Facebook-style reaction emojis (thumbs up + heart) with "[COUNT like 33]".
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Left half: [PRIMARY BRAND COLOR like vibrant teal] background. [YOUR PRODUCT] photographed with dynamic energy — [ACTION DETAIL like chocolate dripping / liquid pouring] to convey indulgence.
        Brand logo in bold white upper-left.
        Below product: vertical stack of 4 benefits, each with a green circle checkmark emoji: "[STRENGTH 1-4 like ≤2G SUGAR / ALL NATURAL INGREDIENTS / ≥6G FIBRE / 12G PROTEIN]" in bold white uppercase.
        Right half: [CONTRAST COLOR like pale cream/beige] background. Generic unbranded competitor product [DESCRIPTION like crumpled foil-wrapped chocolate bar].
        Header: "[COMPETITOR CATEGORY like Other chocolate bars]" in dark text.
        Below: vertical stack of 4 weaknesses, each with a red circle X emoji: "[WEAKNESS 1-4 like 29G SUGAR / FULL OF FRUCTOSE CORN SYRUP / 1G FIBRE / 2G PROTEIN]" in bold dark uppercase.
        Center divider: a comic-style "VS" burst graphic in [ACCENT COLOR like coral/red].
        1:1 aspect ratio.
      `,
    },
    creative: {
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top 50%: lifestyle product photography — [SCENE like a woman's hands holding the product pad / person using the product in context] on a [MOOD like warm, skin-toned, soft-focus] background.
        ...
        Bottom 50%: dark gradient overlay (fading from transparent to [DARK COLOR like deep brown/black]).
        Large bold uppercase sans-serif text: "[STAT-DRIVEN HEADLINE with specific percentages like AFTER SWITCHING TO [BRAND], [X]% OF USERS [RESULT], WHILE [Y]% [SECOND RESULT]]."
        Key result phrases highlighted in [ACCENT COLOR like soft pink / brand secondary color].
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Left 45%: overhead product shot — [PRODUCT DISPLAY DESCRIPTION like a white bowl filled with fresh dog food divided into labeled sections by thin white lines, each section labeled in curved white text: "[VARIETY 1-4 like CHICKEN & YAMS / BEEF N' RICE / SALMON N' RICE / TURKEY & YAMS]"].
        Shot on 50mm f/4, clean white surface.
        Right 55%: white background.
        Top: [STAR RATING like five gold stars] with "[REVIEW COUNT like 10,000+ REVIEWS]" in [BRAND COLOR].
        Brand logo.
        Below: [BRAND COLOR] serif or sans-serif headline: "[HEADLINE like Made for the pickiest dogs]".
        Then 3 checkmark benefit rows, each with a filled [BRAND COLOR] circle checkmark + bold text: "[BENEFIT 1-3 like Head turning aroma / No additives, flavors, or preservatives / Ready to serve from the pouch]".
        Bottom right: large rounded [ACCENT COLOR] CTA button reading "[CTA like SHOP NOW]".
        1:1 aspect ratio.
      `,
    },
    creative: {
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference. Match exact brand colors and typography style.
        Create: a product annotation ad on a [BACKGROUND like warm cream/light yellow textured] background.
        Top: italic serif headline "[BENEFIT STATEMENT like Barista grade coffee. Instant. Affordable.]" in [BRAND COLOR like dark navy].
        Below in massive bold sans-serif: "[VALUE PROP like ALL IN ONE]".
        Center: [PERSON'S HAND] holding [YOUR PRODUCT] at a natural angle.
        Four curved arrows in [BRAND COLOR] pointing from the product outward to four benefit callout labels arranged around it in bold [BRAND COLOR] text: "[CALLOUT 1-4 like NO sugar or calories / Multiple Flavors / Iced, cold or hot / Smooth and delicious]".
        Arrows should feel hand-drawn or editorial, not rigid.
        Bottom: full-width [CONTRAST COLOR like deep navy] banner with [PROMO TEXT like HUGE SALE + FREE GIFTS] in bold [ACCENT COLOR like gold/white] with optional emoji accents.
        1:1 aspect ratio.
      `,
    },
    creative: {
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a casual selfie of [PERSON like a man in mid-20s, beanie, crewneck sweatshirt] doing something mundane [ACTION like brushing teeth, making coffee, cooking].
        iPhone front camera, slightly grainy, bathroom/kitchen lighting, no professional setup.
        Overlaid in the center of the frame: a realistic screenshot of a [PLATFORM like Reddit / Twitter / X] post.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top 15%: white banner overlay with massive bold [BRAND COLOR like dark purple] uppercase sans-serif headline: "[2-3 WORD POWER STATEMENT like APPETITE KILLER.]" with a period for punch.
        Middle 55%: lifestyle product photo — [SCENE like woman's hand holding a capsule above an open supplement jar on a clean surface, soft natural light].
        Product label and branding clearly visible.
        Bottom 25%: [SOFT BRAND COLOR like lavender/light purple] background.
        Three evenly spaced icon-and-text benefit columns: [ICON 1 + LABEL like (crossed-out burger icon) CURB APPETITE] | [ICON 2 + LABEL like (lightning bolt icon) BURN CALORIES] | [ICON 3 + LABEL like (heart + body icon) LOSE WEIGHT].
        Icons are simple line-drawn in [BRAND COLOR] circles.
        Very bottom edge: scrolling ticker bar in [DARK BRAND COLOR] with repeating text: "[SOCIAL PROOF like OVER 300K+ LIVES CHANGED]".
        1:1 aspect ratio.
      `,
    },
    creative: {
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top row divided 50/50: Left: [YOUR PRODUCT] packaging photographed clean on white with [DETAIL like chips spilling out].
        ...
        Each row compares one attribute: Row 1: "[YOUR ADVANTAGE like Uses beef tallow.]" vs "[COMPETITOR WEAKNESS like Uses seed oils.]".
        Row 2: "[YOUR ADVANTAGE like Organic corn.]" vs "[COMPETITOR WEAKNESS like Pesticide corn.]".
        Row 3: "[YOUR ADVANTAGE like Tastes amazing.]" vs "[COMPETITOR WEAKNESS like Doesn't even taste good.]"
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a casual iPhone photo of [PERSON DESCRIPTION like a woman's hand with clean natural nails] holding [YOUR PRODUCT with key packaging details] at a slight angle over [SURFACE/SETTING like a clean white desk with lifestyle props].
        ...
        Bubble 1: "[TOPIC + EMOJI like gut health 🌱]" large and bold.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top 25%: white background with a realistic major publication masthead/logo in large bold black serif text [PUBLICATION STYLE like "Daily Mail" or "TODAY" or "INSIDER"].
        Below: thin gray horizontal rule.
        Small gray text "Latest Headlines" left-aligned.
        Then: bold black serif headline spanning full width: "[HEADLINE like 'It's my holy grail product': The $[PRICE] [PRODUCT CATEGORY] with over [NUMBER] five-star reviews]".
        Bottom 60%: two side-by-side casual UGC-style photos of [PEOPLE like two different young women, one brunette, one blonde] each holding [YOUR PRODUCT] in a casual selfie pose — one taken in natural daylight, one in warm indoor evening light.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top: realistic iOS status bar (time "[TIME like 10:45]", signal bars, wifi icon, battery icon).
        Below: iOS Notes navigation — blue "< All iCloud" back arrow left, share icon and three-dot menu icon right.
        Below nav: small gray timestamp text "[DATE like 13 July 2023 10:44]".
        Main content area on white background: bold black serif headline "[HEADLINE like In Just [DOSAGE] A Day]".
        Below: [3 BENEFIT ROWS], each with a [BRAND COLOR] filled circle checkmark + [EMOJI] + bold black text using food-equivalency format: "[BENEFIT 1 like More Vitamin D than 800 mushrooms]" / "[BENEFIT 2 like More Folate than 4 cups of spinach]" / "[BENEFIT 3 like More Vitamin B1 than 7 cups of broccoli]".
        Right side, overlapping the benefit text slightly: [YOUR PRODUCT] at a slight angle with [DETAILS like a few gummies/capsules spilling out at the base].
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a product showcase ad on a [BACKGROUND COLOR like warm sand/beige/cream] background.
        Top: large bold [BRAND COLOR like chocolate brown] uppercase sans-serif headline: "[SUPERLATIVE CLAIM like THE WORLD'S HEALTHIEST CHOCOLATE]".
        Below headline: white rounded-rectangle CTA button with [BRAND COLOR] uppercase text "[CTA like EXPLORE NOW]".
        Center: [YOUR PRODUCT] in full packaging, angled slightly, hero-lit with soft studio lighting.
        Surrounding the product: [SCATTERED ELEMENTS like broken chocolate pieces, cocoa powder dust, crumbs, ingredient pieces] arranged in an exploded/radial pattern creating visual energy and texture on the background surface.
        Bottom: a white or light rounded-pill stat bar spanning the width with three metrics separated by thin vertical lines: "[STAT 1 like 12G OF PROTEIN]" | "[STAT 2 like ≤2G OF SUGAR]" | "[STAT 3 like ≤3G OF NET CARBS]" in bold [BRAND COLOR] text.
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Create: a lifestyle photo set in [SETTING like a bright modern kitchen].
        In the background: a small tabletop dry-erase whiteboard or flip-chart propped up on [SURFACE like a marble countertop].
        On the whiteboard: two simple hand-drawn black marker line illustrations side by side — left drawing labeled "[BEFORE LABEL like De esto...]" showing [BEFORE STATE like a bloated midsection outline with dots/texture], an arrow pointing right to a second drawing labeled "[AFTER LABEL like A esto!]" showing [AFTER STATE like a flatter, smoother midsection outline].
        Below the drawings on the whiteboard: handwritten text in black marker "[HANDWRITTEN CTA like If you want progress during [PROBLEM], you need this!]".
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        Use the attached images as brand reference. Match the exact product design and brand colors precisely.
        Create: a promotional variant of a hero statement ad on a [BACKGROUND like dark charcoal/moody gray] background.
        Top 12%: white or light banner with massive bold [DARK COLOR] uppercase sans-serif headline: "[PROVOCATIVE 2-3 WORD STATEMENT like FUPA KILLER.]" with a period for punch.
        Upper-left of product area: a [BRIGHT ACCENT COLOR like neon green/lime] comic-style starburst badge rotated slightly, reading "GET UP TO [DISCOUNT like 40%] OFF" in bold black text.
        Center: [PERSON'S HAND] gripping [YOUR PRODUCT] from above, lifting it off its [PACKAGING like retail box] below.
        Product label and branding clearly visible.
        Moody, slightly dramatic lighting.
        Bottom 20%: three evenly spaced icon-and-text benefit columns on a semi-transparent dark strip: [ICON 1 + LABEL like (crossed-out burger) CURB APPETITE] | [ICON 2 + LABEL like (lightning bolt) BURN CALORIES] | [ICON 3 + LABEL like (heart + body) LOSE WEIGHT].
        Icons in simple line-art circles with [ACCENT COLOR] highlights.
        Very bottom: full-width [BRIGHT ACCENT COLOR] banner with bold [DARK] text: "[PROMO like BLACK FRIDAY SPECIAL]".
        1:1 aspect ratio.
      `,
    },
    creative: {
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Left 55%: a casual UGC-style photo of [PERSON like a blonde woman in her early 30s, wearing a casual zip-up sweater] enjoying the product in context — [ACTION like sipping an iced drink through a gold metal straw in a bright café setting].
        Natural lighting, warm and inviting, iPhone-quality casual feel.
        The person should look genuinely happy, not posed.
        Right 45%: solid [PRIMARY BRAND COLOR like deep indigo/purple] background.
        Top-right: small decorative sparkle/star accents in [ACCENT COLOR like gold/yellow].
        Floating center-right: [YOUR PRODUCT] at a slight angle, studio-lit on the colored background.
        Below product: a white rounded-rectangle review card with: five filled [ACCENT COLOR] stars at top, then italic or casual serif text: "[SHORT REVIEW QUOTE like "I will never get drive-thru coffee again"]" in [BRAND COLOR].
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        Top 35%: clean white background with large bold black sans-serif text (heavy weight, tight leading): "[HOOK HEADLINE like Most [AUDIENCE] don't realize THIS is why [PROBLEM STATEMENT] but did you know...]".
        ...
        Bottom 65%: a close-up, slightly uncomfortable or attention-grabbing photo of [PROBLEM VISUAL like the specific physical symptom or problem the product solves — shown on the subject, no product visible].
  ...
  },
  {
    prompt: {
      ...
      promptText: `
        ...
        No attribution line.
        No signature.
        Bottom center of frame, outside the photo on a plain white or off-white strip: small plain lowercase sans-serif caption text, looks like someone typed it under an organic post: "[brand url] — [3-5 word casual caption, sounds typed not written]"
